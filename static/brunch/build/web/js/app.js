...
(function(/*! Stitch !*/) {
  ...
  var HomeView, MainRouter, UploadView, WorksheetView;
  window.app = {};
  app.routers = {};
  app.models = {};
  app.collections = {};
  ...
  exports.MainRouter = (function() {
    ...
    MainRouter.prototype.upload = function() {
      return app.views.upload.render();
    };
    return MainRouter;
  })();
}).call(this);
  ...
  (function() {
    (function() {
      __out.push('<div id="home-view">\n  <h1>HXLator</h1>\n  <p>HXLator is a tool to convert raw humanitarian data from excel formats into the <br/>Humanitarian\neXchange Language(HXL), a universal format of humanitarian activity data.</p>\n<p>The HXL is based on Resource Description Framework (RDF) and Linked Data concept</p>\n<p>this project is created using <a href="http://flask.pocoo.org">Flask</a> and <a href="http://brunch.io">Brunch.io</a></p>\n<a href="#upload"><img src="/static/img/start.png" alt="start HXL"/></a>\n</div>\n');
    }).call(this);
    
  }).call(__obj);
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/upload": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "templates/worksheet": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
